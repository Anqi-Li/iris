...
#    sc_pos = ir.l1.position_ecef
    ...
    def f(i):
        ...
        o3_a = interp1d(apriori.altgrid, apriori.o3_vmr*apriori.m,
                           fill_value="extrapolate")(z)
        T_a = interp1d(apriori.altgrid, apriori.T,
                         fill_value="extrapolate")(z)
        m_a = interp1d(apriori.altgrid, apriori.m,
                         fill_value="extrapolate")(z)
    #        gA = gfactor(0.21*m_SMR, T_SMR, z, sza.sel(mjd=day_mjd_lst[i]).item())
        ...
        return x, xa, np.diag(Sm), A.sum(axis=1), res_lsq.x, o3_a
